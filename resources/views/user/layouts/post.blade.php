    ...
    <div class="intro-section bg-lighter pt-5 pb-6">
        <div class="container">
                        ...
                        <div class="intro-slider intro-slider-1 owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl" data-owl-options='{
                            ...
                            <div class="intro-slide">
                                <figure class="slide-image">
                                    <picture>
                                        <source media="(max-width: 480px)" srcset="{{asset('user/assets/images/slider/slide-1-480w.jpg')}}">
                                        <img src="{{asset('user/assets/images/slider/slide-1.jpg')}}" alt="Image Desc">
                                    </picture>
                            ...
                            <div class="intro-slide">
                                <figure class="slide-image">
                                    <picture>
                                        <source media="(max-width: 480px)" srcset="{{asset('user/assets/images/slider/slide-2-480w.jpg')}}">
                                        <img src="{{asset('user/assets/images/slider/slide-2.jpg')}}" alt="Image Desc">
                                    </picture>
                                </figure><!-- End .slide-image -->
                            ...
                            <div class="intro-slide">
                                <figure class="slide-image">
                                    <picture>
                                        <source media="(max-width: 480px)" srcset="{{asset('user/assets/images/slider/slide-3-480w.jpg')}}">
                                        <img src="{{asset('user/assets/images/slider/slide-3.jpg')}}" alt="Image Desc">
                                    </picture>
                                </figure><!-- End .slide-image -->
            ...
            <div class="owl-carousel owl-simple" data-toggle="owl" 
                ...
                <a href="#" class="brand">
                    <img src="{{asset('user/vassets/images/brands/5.png')}}" alt="Brand Name">
                </a>
    ...
    <div class="container">
        <div class="heading heading-center mb-3">
            ...
            <ul class="nav nav-pills justify-content-center" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="trendy-fur-link" data-toggle="tab" href="{{url('$subcate->id')}}" role="tab" aria-controls="trendy-fur-tab" aria-selected="false">{{$subcate->name}}</a>
                </li>
                @endforeach
                @endforeach
            </ul>
                    ...
                    <div class="product product-11 text-center">
                        ...
                        <div class="product-body">
                            ...
                            <div class="product-price">
                                <span class="new-price">{{$produ->sale_price}}</span>
                                <span class="old-price">Was {{$produ->price}}</span>
            ...
            <div class="owl-carousel owl-simple carousel-with-shadow" data-toggle="owl" 
                ...
                <article class="entry entry-display">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="{{asset('user/assets/images/blog/home/post-1.jpg')}}" alt="image desc">
                        </a>
                ...
                <article class="entry entry-display">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="{{asset('user/assets/images/blog/home/post-2.jpg')}}" alt="image desc">
                        </a>
                    </figure><!-- End .entry-media -->
                ...
                <article class="entry entry-display">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="{{asset('user/assets/images/blog/home/post-3.jpg')}}" alt="image desc">
                        </a>
                    </figure><!-- End .entry-media -->
